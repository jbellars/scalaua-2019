...
object ThinkingFunctionally extends App {
  ...
  def run(args: List[String]): ZIO[Console, Nothing, Int] = putStrLn("Hello World!").fold(_ => 1, _ => 0)
  ...
  lazy val invitation1: ZIO[Services with Clock, Throwable, Option[Receipt]] = inviteFriends(???).timeout(60.seconds)
  ...
  object logging {
    ...
    object Logging {
      ...
      trait Live extends Logging {
        ...
        val logging: Service = new Service {
  ...
  object social {
    ...
    object Social {
      ...
      trait Live extends Social {
        ...
        val social: Service = new Service {
